...
from source.app.ui.ApartmentUI import ApartmentUI
...
class TenantUI:
    ...
    def build_ui(self):
        ...
        self.nav_button(sidebar, "Apartments", self.show_apartments)
    ...
    def show_lease(self):
        ...
        tk.Button(
            self.content,
            text="Open Lease Creation Form",
            bg="#22c55e",
            fg="black",
            command=lambda: LeaseUI(self.window)
        ).pack(pady=10)
